  ...
  return (
    <div className=" w-full ">
        ...
        <div className="bg-white sm:px-4 lg:px-0 px-6  w-full">
          <Image
            src={pimg}
            className="h-[400px]  sm:h-[300px] md:h-[250px] mb-2 xl:h-[400px]  object-cover"
            width={1000}
            height={1000}
            alt="Post Image"
          ...
          />
          <div className='flex '>
           <h5 className='text-red-500 font-bold mt-2 capitalize tex-sm text-left  mb-2 w-fit'>/ / {section}</h5>
           <span className="text-gray-500 text-left mt-3 ml-4 text-sm"> <CreationDate articleNumber={articleNumber}/></span>
           </div>
