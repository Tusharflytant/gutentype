...
import entertainment from "@/constants/classaction";
import Blogs from "@/components/Blogs";
import Posts from "../components/Posts";
import money from "@/constants/medicalclaims";
import politics from "@/constants/personalinjury";
  ...
  return (
    <>
            ...
            >
              <div className="relative w-full h-full">
                ...
                <div className="absolute inset-0 z-10 flex flex-col justify-end p-6">
                  <button className="text-white bg-red-500 px-2 py-2 rounded-xl capitalize  w-fit mb-2  text-sm">
                    / / {post.category}
                  </button>
                      ...
                      <div className="flex items-center gap-2">
                        <Link
                          href={`/authors/${post.authorName
                            ...
                            .toLowerCase()}`}
                        >
                          <p className=" hover:text-red-500 text-sm font-medium tracking-widest text-white capitalize">
                            By {post.authorName}
                          </p>
                        </Link>
                      </div>
      ...
      <div className="bg-gray-100 px-4 lg:px-0 mt-28">
        ...
        <div className="flex flex-col py-10 max-w-7xl mx-auto  lg:flex-row gap-6 ">
          {/* Main Content (Posts) */}
          ...
          <div className="w-full lg:w-[350px] mb-24 bg-white   mt-16 lg:mt-10 rounded-xl shadow-lg px-6 h-fit">
      ...
      <div className="grid max-w-7xl mx-auto  grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 px-4 lg:px-0 justify-items-center  ">
        {usNews.slice(0, 8).map((post, index) => (
          <Link
            key={index}
            href={`/post/${post.title.replace(/[^A-Za-z0-9]+/g, "-")}`}
            passHref
